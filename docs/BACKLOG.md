...
- [ ] **1.2 File upload and drag-drop for specs**
...
- [ ] **1.3 Integrate \$ref resolution into the compare pipeline**
...
- [ ] **1.4 Design polish: input panel and tree adopt the blueprint direction**
...
- [ ] **2.1 Operation-level breaking/safe rules**
...
- [ ] **2.3 Request/response body schema field rules**
...
- [ ] **2.4 Enum and format narrowing rules**
...
- [ ] **2.5 Design polish: rule-category iconography and reason readability**
...
- [ ] **3.1 Breaking-only filter and summary rail**
...
- [ ] **3.4 Markdown export of the diff tree**
